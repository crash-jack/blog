...
public class HttpClick {  
     ...
     // String GET_URL = "http://panda.www.net.cn/cgi-bin/check.cgi?area_domain=teapic.com";  
...
//    public static final String POST_URL = "http://121.40.204.191:8180/mdserver/service/installLock";  
     ...
     * 接口调用 GET 
     */  
    public static String httpURLConectionGET(String fullUrl ,int i) {  
        try {  
            URL url = new URL(fullUrl);    // 把字符串转换为URL请求地址  
